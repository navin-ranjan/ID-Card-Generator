...
//	        contentStream.endText();
	...
	public static IDCardWrapper createIdcardadd(IDCardWrapper idCardWrapper) {
		...
		try {
	        ...
	        BufferedImage image = ImageIO.read(new File("src/main/java/com/idcard/school/pic.jpg"));
	        ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ImageIO.write(image, "jpg", baos);
            byte[] byteArray = baos.toByteArray();
	        PDImageXObject imageXObject = PDImageXObject.createFromByteArray(document, byteArray, "image");
           ...
           byte[] byteArraysign = baosSign.toByteArray();
            ...
            System.out.println(Arrays.toString(byteArraysign));
            
            
            PDImageXObject imageXObject1 = PDImageXObject.createFromByteArray(document, byteArraysign, "image");
	        ...
	        contentStream.drawImage(imageXObject, 850, 400, 130, 150);
	        contentStream.drawImage(imageXObject1, 800, 400, 125, 40);
